...
// Fetched 2026-08-27. 10248 rules.
//
// Bundled rather than guessed. The spike that preceded this extension used an
// 8-entry hand-written list; on any unlisted multi-part suffix that computes
// the registrable domain of a.b.example.qld.edu.au as edu.au, and the
// extension would then ask the user for permission over every school in
// Queensland. The permission prompt is the product's main promise, so the
// domain it names has to be right.
self.PSL_RAW = `ac
com.ac
edu.ac
gov.ac
